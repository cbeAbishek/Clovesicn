        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              Clover Inc. operates globally. Your data may be transferred to countries where we have offices (e.g., India, U.S., Australia) or where our service providers operate. We ensure such transfers comply with applicable laws (e.g., standard contractual clauses).
            </p>
          </section>
