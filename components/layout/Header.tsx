    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:static lg:translate-x-0 lg:translate-y-0">
          <span className="block lg:hidden font-bold text-xl text-gray-900 select-none px-4 py-1 rounded-full border-2 border-[#39b54b] shadow-md bg-white/80">
            <span className="text-[#39b54b]">Cloves</span> Inc
          </span>
        </div>
