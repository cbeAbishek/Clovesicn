...
const HeroBanner = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white">
      ...
      {/* Top Left Shape */}
      <div
      className="absolute top-[-80px] left-[-80px] z-0 pointer-events-none"
      aria-hidden="true"
      >
      <span className="block w-64 h-64 rounded-full bg-green-400/30 blur-3xl animate-green-loop1" />
      </div>
      {/* Bottom Right Shape */}
      <div
      className="absolute bottom-[-100px] right-[-100px] z-0 pointer-events-none"
      aria-hidden="true"
      >
      <span className="block w-80 h-80 rounded-full bg-green-300/20 blur-3xl animate-green-loop2" />
      </div>
      {/* Center Left Shape */}
      <div
      ...
      <div className="w-full  items-center justify-center">
        ...
        {/* Stats */}
        <div className="inline-flex items-center space-x-2 bg-primary-600/10 backdrop-blur-sm border border-primary-400/10 rounded-full px-4 py-2 mb-6 transition-all duration-700 ease-in-out"
        ...
        {/* Subtitle */}
        <p
          className="text-xl sm:text-2xl text-gray-600 mb-8 leading-relaxed max-w-2xl transition-all duration-700 ease-in-out"
  ...
  return (
    <div className="relative overflow-visible">
      ...
      className={`
        ...
        ${isChanging ? 'opacity-0 translate-y-4 blur-sm' : 'opacity-100 translate-y-0 blur-0'}
      `}
      style={{
