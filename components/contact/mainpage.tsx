          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 hover:shadow-2xl transition-shadow duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="group">
                ...
                <div className="relative border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-[#39b54b] transition-colors duration-300 group-hover:bg-gray-50">
                  <input
                    type="file"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#39b54b] text-white py-4 px-6 rounded-xl font-semibold hover:bg-[#2d8f3a] transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 hover:shadow-lg hover:scale-105 active:scale-95"
              >
                {isLoading ? (
                  <>
